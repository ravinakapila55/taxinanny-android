...
public class WeeklyEarningFragment extends Fragment implements RetrofitResponse
{
    ...
    public void initValues(View view)
    {
        ...
        tvLabel.setText("WEEKLY TRIP");
        recycler.setLayoutManager(new LinearLayoutManager(getActivity()));
        callWeeklyEarning();
    }

    private void callWeeklyEarning()
    {
            ...
            case 105:
                ...
                try {
                    ...
                    if (jsonObject.getString("status").equalsIgnoreCase("true")) {
                        ...
                        JSONArray Array = data.getJSONArray("weekly");

                        tvEarning.setText(data.getString("amount_final_weekly")+" $");

                        tvTrip.setText(data.getString("No_of_trips_weekly"));
                        ...
                        try {
                            date = input.parse(data.getString("time_weekly"));
