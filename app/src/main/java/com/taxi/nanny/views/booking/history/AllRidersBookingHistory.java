...
public class AllRidersBookingHistory extends BaseActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        setHeaderText("List of Riders History");
    ...
    {
        BookingHistoryAdapter historyAdapter=new BookingHistoryAdapter(this,rides_list);
